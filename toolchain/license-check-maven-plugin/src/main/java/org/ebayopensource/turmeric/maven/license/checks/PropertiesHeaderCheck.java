...
public class PropertiesHeaderCheck implements Checker {
    private HeaderCheck header;

    public PropertiesHeaderCheck() throws MojoExecutionException {
        header = new HeaderCheck("properties-header.regex");
    }
